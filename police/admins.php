            ...
            <div class="row container d-flex justify-content-center" style="margin: auto">
                ...
                <div class="card user-card-full">
                    <div class="row m-l-0 m-r-0">
                        ...
                        $conn = $con->open();
                        $sql = $conn->prepare("SELECT * FROM police ");
                        $sql->execute();
                        $get = $sql->fetchAll();
                                ...
                                echo
                                    ...
                                    <tr>
                                      <td>
                                        ...
                                        <td class="text-right">
                                            <a id="'.$data["id"].'" class="edit-police" href="#"><i class="fa fa-edit text-warning"></i></a>
                                            <a id="'.$data["id"].'" class="delete-police" href="#"><i class="fa fa-trash"></i></a>
                                        </td>
                                    </tr>
                                    ';
                            }
