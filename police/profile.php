                            ...
                            <div class="col-sm-8">
                                <div class="card-block">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-6">
                                            <p class="m-b-10 f-w-600">Profile Status</p>
                ...
                <div class="card shadow-lg border-0 rounded-lg edit-profile">
                    ...
                    <div class="card-body">
                        <form method="POST" action="handler.php" onsubmit="return sendFormU()">
                            ...
                            <input name="police_edit" value="edit_pol" hidden>
                            <input name="edit_id" value="<?php echo $_SESSION['id'] ?>" hidden>
                            <div class="row mb-3">
                                <div class="col-md-6">
                                    <div class="form-floating mb-3 mb-md-0">
                                        <input class="form-control" name="inputFirstName" value="<?php echo $_SESSION['name'] ?>" type="text" minlength="3" placeholder="Enter your first name" onkeypress="return /[a-z]/i.test(event.key)"  required/>
                                        <label for="inputFirstName">First name</label>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-floating">
                                        <input class="form-control" name="inputLastName" value="<?php echo $_SESSION['surname'] ?>" type="text" minlength="3" placeholder="Enter your last name"  onkeypress="return /[a-z]/i.test(event.key)" required/>
